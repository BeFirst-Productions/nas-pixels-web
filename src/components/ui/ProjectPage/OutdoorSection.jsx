            ...
            <Container>
                <div className="w-full flex flex-col justify-center  px-6">
                    ...
                    <div className="flex justify-center mb-12">
                        <h2 className="text-white text-xl px-6 py-2 rounded-full border border-green-400">
                            Outdoor
                        </h2>
                    </div>
                    ...
                    <div className="space-y-6 max-w-6xl mx-auto w-full ">
                        {projects.map((item, i) => (
                            ...
                            >
                                <div className="flex flex-col md:flex-row  md:h-[340px]  p-4 rounded-xl overflow-hidden">
