...
export function FallingPattern({
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Infinite falling animation using GSAP
        ...
        tl.fromTo(
          ...
          },
          {
            ...
            duration: duration,
            ease: 'none', // Linear for smooth continuous fall
          }
        );

        console.log('✅ GSAP Falling Pattern initialized');
      } catch (error) {
  ...
  }, [duration, startPositions, endPositions]);
